...
import If from '../comum/operador/if'
import Messages from '../comum/msg/mensagens'
import Input from '../comum/form/inputAuth'
    ...
    render(){
        ...
        return(
            <div className="login-box">
                <div className="login-logo"><b>Ciclo</b> Pagamento</div>
