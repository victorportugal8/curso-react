...
function sum(a, b){
    ...
    while(Date.now() < future){} //vai causar uma espera de 2s
    return a + b
}
...
const UseMemo = (props) => {
    ...
    const result = useMemo(() => sum(n1,n2), [n1,n2]) //modificando o n3 sem o tempo de espera com o useMemo

    // useEffect(function(){
    //     setResult(sum(n1, n2))
    // }, [n1, n2]) //com isso, o n3 pode ser modificado sem o tempo de espera
    return (
